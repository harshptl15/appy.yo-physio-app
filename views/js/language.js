(function () {
  ...
  const TRANSLATIONS = {
    english: {
      ...
      'routine.nowTraining': 'Now Training',
      'routine.restart': 'Restart Routine',
      'routine.newSearch': 'New Search',
      'routine.showFavourites': 'Show Favourites',
      'routine.removeCurrent': 'Remove Current Exercise',
      'routine.addToFavourites': 'Add to Favourites',
      'routine.addedToFavourites': 'Added to Favourites',
      'routine.alreadyFavourite': 'Already in favourites',
      ...
      'auth.panel.eyebrow': 'Personalized Recovery Companion',
      'auth.panel.title': 'Move better with a plan built around your recovery.',
      'auth.panel.subtitle': 'Stay consistent with guided routines, progress insights, and secure account access.',
      'auth.username': 'Username',
      'auth.usernameOrEmail': 'Username or Email',
      'auth.password': 'Password',
      'auth.forgotPassword': 'Forgot password?',
      'auth.security.reassurance': 'Secure account access',
      'auth.loading': 'Please wait...',
      'auth.placeholder.emailOrUsername': 'Enter your username or email',
      'auth.placeholder.password': 'Enter your password',
      'auth.placeholder.email': 'Enter your email',
      'auth.placeholder.username': 'Choose a username',
      ...
      'auth.login.subtitle.new': 'Sign in to continue your recovery plan and track your progress.',
      'auth.login.signIn': 'Sign in',
      'auth.login.createAccountPrompt': "Don't have an account?",
      ...
      'auth.register.createTitle': 'Create your account',
      'auth.register.subtitle.new': 'Start your recovery journey with a personalized physio experience.',
      'auth.register.email': 'Email Address',
      'auth.register.retypePassword': 'Re-type Password',
      'auth.register.terms': 'I agree to the terms and conditions',
      'auth.register.passwordHint': 'Use at least 6 characters.',
      'auth.register.passwordWeak': 'Password is too short.',
      'auth.register.passwordGood': 'Password length looks good.',
      'auth.register.termsLead': 'I agree to the',
      ...
      'auth.register.clear': 'Clear',
      'auth.register.signInPrompt': 'Already have an account?',
      ...
      'dashboard.nav.viewGoals': 'View goals',
      'dashboard.nav.enable2fa': 'Enable 2FA',
      'dashboard.nav.disable2fa': 'Disable 2FA',
      'dashboard.title': 'Your Progress',
      'dashboard.header.welcomeBack': 'Welcome back',
      'dashboard.header.subtitle': "Here's your recovery progress for today.",
      'dashboard.stat.streakNew': 'Current streak',
      'dashboard.stat.streakSupport': 'Keep your recovery momentum',
      'dashboard.stat.lastWorkoutNew': 'Last completed workout',
      'dashboard.stat.lastWorkoutSupport': 'Latest completed session',
      'dashboard.stat.nextRestNew': 'Next rest day',
      'dashboard.stat.nextRestSupport': 'Planned recovery window',
      'dashboard.stat.goalProgressNew': 'Goal progress',
      'dashboard.stat.goalProgressSupport': 'Progress toward your targets',
      'dashboard.cta.startWorkoutNew': 'Start workout',
      'dashboard.cta.goalsNew': 'View goals',
      'dashboard.todayPlan': "Today's plan",
      'dashboard.progress.weekly': 'Weekly completion',
      'dashboard.tip.title': 'Recovery tip',
      'dashboard.tip.body': 'Short mobility sessions on rest days can improve consistency and lower next-day soreness.',
      'dashboard.reminder.title': 'Upcoming routine',
      'dashboard.reminder.body': 'Plan your next session now to keep your streak active.',
      'dashboard.reminder.link': 'View routine',
      'dashboard.checkin.title': 'Weekly progress check-in',
      'dashboard.checkin.mood': 'Mood (optional)',
      'dashboard.checkin.pain': 'Average pain (0-10)',
      'dashboard.checkin.mobility': 'Mobility rating (1-5)',
      'dashboard.checkin.notes': 'Notes (optional)',
      'dashboard.checkin.submit': 'Submit check-in',
      'dashboard.checkin.saving': 'Saving...',
      'dashboard.checkin.saved': 'Check-in saved.',
      'dashboard.checkin.failed': 'Failed to submit check-in.',
      ...
      'placeholder.forgot.heading': 'Forgot password',
      'placeholder.forgot.body': 'Password recovery is not connected yet. Please contact support for account help.',
      'placeholder.terms.heading': 'Terms & Conditions',
      'placeholder.terms.body': 'This legal page is being prepared and will be available in a future update.',
      'placeholder.privacy.heading': 'Privacy Policy',
      'placeholder.privacy.body': 'Your privacy policy page is being prepared and will be available soon.',
      'placeholder.backLogin': 'Back to sign in'
    },
    spanish: {
      ...
      'routine.nowTraining': 'Entrenando ahora',
      'routine.restart': 'Reiniciar rutina',
      'routine.newSearch': 'Nueva busqueda',
      'routine.showFavourites': 'Mostrar favoritos',
      'routine.removeCurrent': 'Eliminar ejercicio actual',
      'routine.addToFavourites': 'Agregar a favoritos',
      'routine.addedToFavourites': 'Agregado a favoritos',
      'routine.alreadyFavourite': 'Ya esta en favoritos',
      'routine.allCompleted': 'Todos los ejercicios de tu rutina estan completados!',
      'routine.markComplete': 'Marcar como completado',
      ...
      'auth.panel.eyebrow': 'Companero de recuperacion personalizada',
      'auth.panel.title': 'Mejor movimiento con un plan adaptado a tu recuperacion.',
      'auth.panel.subtitle': 'Mantente constante con rutinas guiadas, progreso y acceso seguro.',
      'auth.username': 'Nombre de usuario',
      'auth.usernameOrEmail': 'Usuario o correo',
      'auth.password': 'Contrasena',
      'auth.forgotPassword': 'Olvidaste tu contrasena?',
      'auth.security.reassurance': 'Acceso seguro a la cuenta',
      'auth.loading': 'Por favor espera...',
      'auth.placeholder.emailOrUsername': 'Ingresa tu usuario o correo',
      'auth.placeholder.password': 'Ingresa tu contrasena',
      'auth.placeholder.email': 'Ingresa tu correo',
      'auth.placeholder.username': 'Elige un nombre de usuario',
      'auth.placeholder.createPassword': 'Crea una contrasena',
      'auth.placeholder.confirmPassword': 'Confirma tu contrasena',
      'auth.reset': 'Reiniciar',
      'auth.here': 'aqui',
      'auth.login.title': 'Inicia sesion en tu cuenta',
      'auth.login.welcomeBack': 'Bienvenido de nuevo',
      'auth.login.subtitle.new': 'Inicia sesion para continuar tu plan y ver tu progreso.',
      'auth.login.signIn': 'Iniciar sesion',
      'auth.login.createAccountPrompt': 'No tienes una cuenta?',
      'auth.login.createAccountLink': 'Crear una',
      ...
      'auth.register.createTitle': 'Crea tu cuenta',
      'auth.register.subtitle.new': 'Comienza tu recuperacion con una experiencia personalizada.',
      ...
      'auth.register.passwordHint': 'Usa al menos 6 caracteres.',
      'auth.register.passwordWeak': 'La contrasena es muy corta.',
      'auth.register.passwordGood': 'La longitud se ve bien.',
      'auth.register.termsLead': 'Acepto los',
      'auth.register.termsLink': 'Terminos y condiciones',
      'auth.register.privacyLink': 'Politica de privacidad',
      'auth.register.and': 'y',
      'auth.register.createButton': 'Crear cuenta',
      'auth.register.clear': 'Limpiar',
      'auth.register.signInPrompt': 'Ya tienes una cuenta?',
      'auth.register.signInLink': 'Iniciar sesion',
      ...
      'dashboard.nav.viewGoals': 'Ver metas',
      'dashboard.nav.enable2fa': 'Activar 2FA',
      'dashboard.nav.disable2fa': 'Desactivar 2FA',
      'dashboard.title': 'Tu progreso',
      'dashboard.header.welcomeBack': 'Bienvenido de nuevo',
      'dashboard.header.subtitle': 'Este es tu progreso de recuperacion de hoy.',
      'dashboard.stat.streakNew': 'Racha actual',
      'dashboard.stat.streakSupport': 'Mantiene tu consistencia',
      'dashboard.stat.lastWorkoutNew': 'Ultimo entrenamiento completado',
      'dashboard.stat.lastWorkoutSupport': 'Sesion mas reciente',
      'dashboard.stat.nextRestNew': 'Proximo dia de descanso',
      'dashboard.stat.nextRestSupport': 'Ventana de recuperacion',
      'dashboard.stat.goalProgressNew': 'Progreso de metas',
      'dashboard.stat.goalProgressSupport': 'Avance hacia tus objetivos',
      'dashboard.cta.startWorkoutNew': 'Comenzar entrenamiento',
      'dashboard.cta.goalsNew': 'Ver metas',
      'dashboard.todayPlan': 'Plan de hoy',
      'dashboard.progress.weekly': 'Cumplimiento semanal',
      'dashboard.tip.title': 'Consejo de recuperacion',
      'dashboard.tip.body': 'Sesiones cortas de movilidad en dias de descanso ayudan a mejorar la consistencia.',
      'dashboard.reminder.title': 'Proxima rutina',
      'dashboard.reminder.body': 'Planea tu proxima sesion para mantener tu racha activa.',
      'dashboard.reminder.link': 'Ver rutina',
      'dashboard.checkin.title': 'Chequeo semanal de progreso',
      'dashboard.checkin.mood': 'Estado de animo (opcional)',
      'dashboard.checkin.pain': 'Dolor promedio (0-10)',
      'dashboard.checkin.mobility': 'Movilidad (1-5)',
      'dashboard.checkin.notes': 'Notas (opcional)',
      'dashboard.checkin.submit': 'Enviar chequeo',
      'dashboard.checkin.saving': 'Guardando...',
      'dashboard.checkin.saved': 'Chequeo guardado.',
      'dashboard.checkin.failed': 'No se pudo enviar el chequeo.',
      ...
      'placeholder.forgot.heading': 'Olvidaste tu contrasena',
      'placeholder.forgot.body': 'La recuperacion de contrasena aun no esta conectada.',
      'placeholder.terms.heading': 'Terminos y condiciones',
      'placeholder.terms.body': 'Esta pagina legal estara disponible en una proxima actualizacion.',
      'placeholder.privacy.heading': 'Politica de privacidad',
      'placeholder.privacy.body': 'La pagina de privacidad estara disponible pronto.',
      'placeholder.backLogin': 'Volver a inicio de sesion'
    },
    french: {
      ...
      'routine.nowTraining': 'Entrainement en cours',
      'routine.restart': 'Redemarrer la routine',
      'routine.newSearch': 'Nouvelle recherche',
      'routine.showFavourites': 'Afficher les favoris',
      'routine.removeCurrent': 'Retirer exercice actuel',
      'routine.addToFavourites': 'Ajouter aux favoris',
      'routine.addedToFavourites': 'Ajoute aux favoris',
      'routine.alreadyFavourite': 'Deja dans les favoris',
      'routine.allCompleted': 'Tous les exercices de votre routine sont termines !',
      'routine.markComplete': 'Marquer termine',
      ...
      'auth.panel.eyebrow': 'Compagnon de recuperation personnalise',
      'auth.panel.title': 'Bougez mieux avec un plan adapte a votre recuperation.',
      'auth.panel.subtitle': 'Restez constant avec des routines guidees et un acces securise.',
      'auth.username': "Nom d'utilisateur",
      'auth.usernameOrEmail': 'Nom utilisateur ou e-mail',
      'auth.password': 'Mot de passe',
      'auth.forgotPassword': 'Mot de passe oublie ?',
      'auth.security.reassurance': 'Acces securise au compte',
      'auth.loading': 'Veuillez patienter...',
      'auth.placeholder.emailOrUsername': 'Entrez votre nom utilisateur ou e-mail',
      'auth.placeholder.password': 'Entrez votre mot de passe',
      'auth.placeholder.email': 'Entrez votre e-mail',
      'auth.placeholder.username': "Choisissez un nom d'utilisateur",
      'auth.placeholder.createPassword': 'Creez un mot de passe',
      ...
      'auth.login.subtitle.new': 'Connectez-vous pour poursuivre votre plan de recuperation.',
      'auth.login.signIn': 'Se connecter',
      'auth.login.createAccountPrompt': "Vous n'avez pas de compte ?",
      'auth.login.createAccountLink': 'En creer un',
      ...
      'auth.register.createTitle': 'Creez votre compte',
      'auth.register.subtitle.new': 'Commencez votre recuperation avec une experience personnalisee.',
      ...
      'auth.register.passwordHint': 'Utilisez au moins 6 caracteres.',
      'auth.register.passwordWeak': 'Le mot de passe est trop court.',
      'auth.register.passwordGood': 'La longueur est correcte.',
      'auth.register.termsLead': "J'accepte les",
      'auth.register.termsLink': 'Conditions generales',
      'auth.register.privacyLink': 'Politique de confidentialite',
      'auth.register.and': 'et',
      'auth.register.createButton': 'Creer un compte',
      'auth.register.clear': 'Effacer',
      'auth.register.signInPrompt': 'Vous avez deja un compte ?',
      ...
      'dashboard.nav.viewGoals': 'Voir objectifs',
      'dashboard.nav.enable2fa': 'Activer 2FA',
      'dashboard.nav.disable2fa': 'Desactiver 2FA',
      'dashboard.title': 'Votre progression',
      'dashboard.header.welcomeBack': 'Bon retour',
      'dashboard.header.subtitle': "Voici votre progression de recuperation aujourd'hui.",
      'dashboard.stat.streakNew': 'Serie actuelle',
      'dashboard.stat.streakSupport': 'Maintenez votre elan',
      'dashboard.stat.lastWorkoutNew': 'Derniere seance terminee',
      'dashboard.stat.lastWorkoutSupport': 'Seance la plus recente',
      'dashboard.stat.nextRestNew': 'Prochain jour de repos',
      'dashboard.stat.nextRestSupport': 'Fenetre de recuperation',
      'dashboard.stat.goalProgressNew': 'Progression des objectifs',
      'dashboard.stat.goalProgressSupport': 'Avancement vers vos cibles',
      'dashboard.cta.startWorkoutNew': 'Demarrer entrainement',
      'dashboard.cta.goalsNew': 'Voir objectifs',
      'dashboard.todayPlan': "Plan d'aujourd'hui",
      'dashboard.progress.weekly': 'Completion hebdomadaire',
      'dashboard.tip.title': 'Conseil recuperation',
      'dashboard.tip.body': 'De courtes sessions de mobilite les jours de repos ameliorent la constance.',
      'dashboard.reminder.title': 'Routine a venir',
      'dashboard.reminder.body': 'Planifiez votre prochaine seance pour garder votre serie active.',
      'dashboard.reminder.link': 'Voir routine',
      'dashboard.checkin.title': 'Bilan hebdomadaire',
      'dashboard.checkin.mood': 'Humeur (optionnel)',
      'dashboard.checkin.pain': 'Douleur moyenne (0-10)',
      'dashboard.checkin.mobility': 'Mobilite (1-5)',
      'dashboard.checkin.notes': 'Notes (optionnel)',
      'dashboard.checkin.submit': 'Envoyer bilan',
      'dashboard.checkin.saving': 'Enregistrement...',
      'dashboard.checkin.saved': 'Bilan enregistre.',
      'dashboard.checkin.failed': "Echec de l'envoi du bilan.",
      ...
      'placeholder.forgot.heading': 'Mot de passe oublie',
      'placeholder.forgot.body': "La recuperation du mot de passe n'est pas encore connectee.",
      'placeholder.terms.heading': 'Conditions generales',
      'placeholder.terms.body': 'Cette page juridique sera disponible dans une prochaine mise a jour.',
      'placeholder.privacy.heading': 'Politique de confidentialite',
      'placeholder.privacy.body': 'La page de confidentialite sera disponible bientot.',
      'placeholder.backLogin': 'Retour a la connexion'
    }
  };
